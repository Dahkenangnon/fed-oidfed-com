		...
		},
		{
			...
			metadata: {
				openid_provider: {
					...
					userinfo_endpoint: `${OP_UNI}/me`,
					pushed_authorization_request_endpoint: `${OP_UNI}/request`,
					federation_registration_endpoint: `${OP_UNI}/federation_registration`,
					jwks_uri: `${OP_UNI}/jwks`,
		...
		},
		{
			...
			metadata: {
				openid_provider: {
					...
					userinfo_endpoint: `${OP_HOSPITAL}/me`,
					pushed_authorization_request_endpoint: `${OP_HOSPITAL}/request`,
					federation_registration_endpoint: `${OP_HOSPITAL}/federation_registration`,
					jwks_uri: `${OP_HOSPITAL}/jwks`,
					response_types_supported: ["code"],
					subject_types_supported: ["public"],
					id_token_signing_alg_values_supported: ["ES256", "RS256"],
					client_registration_types_supported: ["automatic", "explicit"],
