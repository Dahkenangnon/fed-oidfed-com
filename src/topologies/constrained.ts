		...
		},
		{
			...
			metadata: {
				openid_provider: {
					...
					userinfo_endpoint: `${OP_DIRECT}/me`,
					pushed_authorization_request_endpoint: `${OP_DIRECT}/request`,
					federation_registration_endpoint: `${OP_DIRECT}/federation_registration`,
					jwks_uri: `${OP_DIRECT}/jwks`,
		...
		},
		{
			...
			metadata: {
				openid_provider: {
					...
					userinfo_endpoint: `${OP_DEEP}/me`,
					pushed_authorization_request_endpoint: `${OP_DEEP}/request`,
					federation_registration_endpoint: `${OP_DEEP}/federation_registration`,
					jwks_uri: `${OP_DEEP}/jwks`,
					response_types_supported: ["code"],
					subject_types_supported: ["public"],
					id_token_signing_alg_values_supported: ["ES256", "RS256"],
					client_registration_types_supported: ["automatic", "explicit"],
